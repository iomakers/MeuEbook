...
const char* PSWD = "internet2018";

// Seu servidor
String host = "192.168.0.12"; // Host => bucket-name.s3.region.amazonaws.com
// usa a porta 8081
int port = 8081; // Non https. For HTTPS 443. As of today, HTTPS doesn't work.
