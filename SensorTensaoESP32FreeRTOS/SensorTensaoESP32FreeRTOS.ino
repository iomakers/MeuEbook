...
float ganho = 200;
int i = 0;
// declarar protótipo da tarefa que irá realizar leitura do sensor de corrente
static void leituraSensorTensao(void * );
...
void setup() {
  ...
  xTaskCreate(leituraSensorTensao, "leituraSensorTensao", 4096,   NULL, 1, NULL);
